...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style4">Add Organ Name for Blockchain Hash Code </span></h2>
          <p>&nbsp;</p>                  
        <form action="A_Organ_Type1.jsp" method="post" enctype="multipart/form-data">
		  <p>&nbsp;</p>
		  <table width="321" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td  width="147" height="55" valign="middle" style="color: #2c83b0;"><div align="left" class="style7 style15 style18 style21 style4" style="margin-left:20px;">Enter Organ Name </div></td>
              <td  width="160" height="55" valign="middle" style="color:#000000;"><label>
              <select name="organ_name">
	      ...
	      <p align="right">&nbsp;</p>
	      <p align="left"><a href="Hospital_Main.jsp" class="style11"><strong>Back</strong></a></p>
		</form>
  <p align="right">&nbsp;</p>
        </div>
      </div>
