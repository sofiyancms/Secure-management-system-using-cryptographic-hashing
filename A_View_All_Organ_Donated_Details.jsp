...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>View All Organ Donated Details...<span class="style5"></span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
		  ...
		  <table width="716" height="111" border="1" align="left"  cellpadding="0" cellspacing="0"  ">
                    ...
                    <%
						...
						try 
						{
						   	String query="select * from organ_donated_details"; 
          ...
          <td height="49" align="center"  valign="middle"><div align="center" class="style5 style20 style37 style54 style55 style22">
					...
					<td height="49" align="center"  valign="middle"><div align="center" class="style5 style20 style37 style54 style55 style22">
                      ...
                      <%
						if(s9.equalsIgnoreCase("Processing"))
						{
                      ...
                      <td height="49"align="center" valign="middle" bgcolor="#FFFF00" style="color:#000000;"><div align="center" class="style22 style5 style20 style30 style37">
                          <div align="center" class="style20 style37 style46"><a href="A_Organ_Process_Status.jsp?type=<%="oprocess"%>&id=<%=i%>" class="style30 style32 style9"><b>Processing</b></a></div>
                      </div></td>
                      <%
						}
						else
                      ...
                      <%
						...
						<td height="49" align="center"  valign="middle" bgcolor="#FFFF00"><div align="center" class="style5 style20 style37 style54 style55 style22">
							...
							<%
						if(s11.equalsIgnoreCase("Waiting"))
						{
                      ...
                      <td width="43" height="49"align="center" valign="middle" style="color:#000000;"><div align="center" class="style22 style5 style20 style30 style37">
                          <div align="center" class="style20 style37 style46"><a href="A_Organ_Process_Status.jsp?type=<%="otransplant"%>&id=<%=i%>" class="style30 style32 style9"><b>Waiting</b></a></div>
                      </div></td>
                      <%
						}
						else
