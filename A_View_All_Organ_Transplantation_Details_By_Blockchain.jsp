...
<head>
<title>A_View_All_Organ_Transplantation_Details_By_Blockchain</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style23">View All Organ Transplantation Details By Blockchain !!! </h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
...
//						count1=count1+1;
						   		String query="select * from organ_transplantation_request_details where hcode = '"+hsign+"' "; 
