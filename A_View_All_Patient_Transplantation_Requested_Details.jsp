...
<head>
<title>A_View_All_Patient_Transplantation_Requested_Details</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style23">View All Patient Transplantation Requested Details...</h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
		  ...
		  <table width="716" height="111" border="1" align="left"  cellpadding="0" cellspacing="0"  ">
                    <tr>
					  ...
					  <td  width="40" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style57 style56 style7"><b>Patient Name</b></div></td>
					  <td  width="40" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style57 style56 style7"><b>Patient Age</b></div></td>		
                      ...
                      <td  width="68" height="34" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style57 style56 style7"><b>Requested  Status</b></div></td>
                    ...
                    <%
						...
						try 
						{
						   	String query="select * from organ_transplantation_request_details"; 
          ...
          <td height="49" align="center"  valign="middle"><div align="center" class="style5 style20 style37 style54 style55 style22">
					...
					<td height="49" align="center"  valign="middle"><div align="center" class="style5 style20 style37 style54 style55 style22">
                      ...
                      <%
						if(s8.equalsIgnoreCase("Processing"))
						{
                      ...
                      <td height="49"align="center" valign="middle" bgcolor="#FFFF00" style="color:#000000;"><div align="center" class="style22 style5 style20 style30 style37">
                          <div align="center" class="style20 style37 style46"><a href="A_Organ_Transplantation_Status.jsp?type=<%="rprocess"%>&id=<%=i%>" class="style30 style32 style9"><b>Processing</b></a></div>
                      </div></td>
                      <%
						}
						else
						{
						%>
                      <td width="66" height="49" align="center"  valign="middle"><div align="center" class="style22 style5 style20 style37 style55 style58">
                       <b><%out.println(s8);%></b>
                      </div></td>
                      <%
						}
						...
						%>
						<td height="49" align="center"  valign="middle" bgcolor="#FFFF00"><div align="center" class="style5 style20 style37 style54 style55 style22">
                            <span class="style22">
                            <%out.println(s9);%>
                      </span></div></td>
							<%
                      ...
                      <td width="43" height="49"align="center" valign="middle" style="color:#000000;"><div align="center" class="style22 style5 style20 style30 style37">
                          <div align="center" class="style20 style37 style46"><a href="A_Organ_Transplantation_Status.jsp?type=<%="otransplant"%>&id=<%=i%>" class="style30 style32 style9"><b>Waiting</b></a></div>
                      </div></td>
                      <%
						}
						else
						{
						%>
                      <td width="23" height="49" align="center"  valign="middle"><div align="center" class="style22 style5 style20 style37 style55 style58">
                       <b><%out.println(s10);%></b>
                      </div></td>
                      <%
						}
