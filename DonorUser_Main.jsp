...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Welcome  Donor User :: <%=(String)application.getAttribute("cuser")%></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          
          <div class="post_content">
            
            <p><img src="images/Organ-Donor.jpg" width="580" height="343" /></p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><strong><a href="DonorUserProfile.jsp">View Profile</a></strong></li>
			<li><strong><a href="Donor_Add_Organ_Donating_Details.jsp">Send Organ Donating Details</a></strong></li>
		    <li><strong><a href="Donor_View_All_Organ_Donated_Details.jsp">View Organ Donated Details Status</a></strong></li>
