...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Welcome Patient::<%=(String)application.getAttribute("user")%></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          
          <div class="post_content">
            <p><img src="images/Patient.jpg" width="560" height="224" /></p>
          </div>
          <div class="clr"></div>
        </div>
      </div>
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><strong><a href="User_Request_Organ_Transplantation_Details.jsp">Register For Organ Transplantation</a></strong></li>
			<li><strong><a href="User_View_All_Organ_Transplantation_Details.jsp">View All Organ Transplantation Details</a></strong></li>
