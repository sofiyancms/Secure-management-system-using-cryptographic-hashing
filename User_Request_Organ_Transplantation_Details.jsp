...
<head>
<title>User_Request_Organ_Transplantation_Details1</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Request Organ Transplantation Details</h2>
		  ...
		  <form action="User_Request_Organ_Transplantation_Details1.jsp" method="post" enctype="multipart/form-data">
...
<td  width="188" height="45" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style7 style18 style19 style1" style="margin-left:20px;">Select Organ Type </div></td>
					...
					<tr>
<td  width="188" height="45" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style1 style18 style7" style="margin-left:20px;"><strong>Patient  Name </strong></div></td>
<td  width="291" valign="middle" height="45" style="color:#000000;"><div align="left" style="margin-left:20px;">
    ...
    <div align="left">
      <input type="text" name="pname">
					...
					<tr>
<td  width="188" height="45" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style1 style18 style7" style="margin-left:20px;"><strong>Patient  Age</strong></div></td>
<td  width="291" valign="middle" height="45" style="color:#000000;"><div align="left" style="margin-left:20px;">
...
<td  width="291" align="left" valign="middle" height="45"><div align="left" style="margin-left:20px;">
    ...
    <div align="left">
      <input type="text" name="height">
					...
					<div > <tr><td height="45" colspan="2" id="learn_more" align="center"  style="color:#FFFFFF;"><input type="submit" value="Request" style="width:100px; height:35px; background-color:#000000; color:#FFFFFF;"/>
					&nbsp;&nbsp;
<input type="reset" name="Reset" style="width:100px; height:35px; background-color:#000000; color:#FFFFFF;"/></td></tr></div>
			</table>
		  </form>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
          <li><a href="DonorUser_Main.jsp"><span>Admin Main </span></a></li>
