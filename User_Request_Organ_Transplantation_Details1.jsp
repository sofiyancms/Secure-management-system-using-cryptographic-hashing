...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style22">Organ Request Details Added Status !!! </h2>
		  ...
		  <%
				try {
					...
					String file=null;
					String organ_name=null,pname=null,age=" ",bg=null,height=null,weight=null;
					String ee=null;
					String checkBok=" ";
					int ff=0;
					String bin = "";
					...
					File file1 = null;	
						...
						while (params.hasMoreElements()) 
						{
							...
							String str = "select * from organ_transplantation_request_details where organ_name='"+organ_name+"' and patient_name='"+pname+"' ";
							Statement st = connection.createStatement();
							ResultSet rs = st.executeQuery(str);
							if(rs.next())
							{
							%><p class="style21">Requested Already </p>
							  <p align="right"><a href="User_Request_Organ_Transplantation_Details.jsp">Back</a></p>
							<%
							}
							else
							{
							
							String luser=(String)application.getAttribute("user");
					...
					String h1 = bi1.toString(16);
			             ...
			             //   String encrypted2 = new String(Base64.encode(uses.getBytes()));
                            ...
                            PreparedStatement ps=connection.prepareStatement("insert into organ_transplantation_request_details(							 			organ_name,patient_name,patient_age,blood_group,height,weight,requested_date,requested_status,hcode,tstatus) values(?,?,?,?,?,?,?,?,?,?)");
							...
							ps.setString(9,h1);
							ps.setString(10,tstatus);
							
							
							ps.executeUpdate();
							
							%>
							   <p class="style20">Transplantation Request Details Added Sucessfully</p>
							   <p align="right"><a href="User_Request_Organ_Transplantation_Details.jsp">Back</a></p>
							<%
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
          <li><a href="User_Main.jsp"><span>Patient Main </span></a></li>
