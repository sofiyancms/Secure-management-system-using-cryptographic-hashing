...
<head>
<title>User_View_All_Organ_Transplantation_Details</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>View All Organ Transplantation Details...<span class="style5"></span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
		  ...
		  <table width="716" height="111" border="1" align="left"  cellpadding="0" cellspacing="0"  ">
                    ...
                    <%
						...
						try 
						{
						   	String query="select * from organ_transplantation_request_details where patient_name='"+user+"' "; 
